...
export const campaigns: ReadonlyArray<HotelCampaign> = [
  {
    ...
    talent: [
      { creatorId: 'sofie-larsen', name: 'Sofie Larsen', initials: 'SL' },
      { creatorId: 'clara-moreau', name: 'Clara Moreau', initials: 'CM' },
      { creatorId: 'ida-moller', name: 'Ida Møller', initials: 'IM' },
      { creatorId: 'anna-berg', name: 'Anna Berg', initials: 'AB' },
    ],
    estimatedReach: '1.2M',
    estimatedEmv: '€82,400',
    bookings: '32',
  ...
  },
  {
    ...
    talent: [
      { creatorId: 'sofie-larsen', name: 'Sofie Larsen', initials: 'SL' },
      { creatorId: 'ida-moller', name: 'Ida Møller', initials: 'IM' },
      { creatorId: 'maya-holm', name: 'Maya Holm', initials: 'MH' },
    ],
    estimatedReach: '940K',
    estimatedEmv: '€64,200',
    bookings: '24',

...
export const creators: ReadonlyArray<Creator> = [
  ...
  { id: 'ida-moller', name: 'Ida Møller', initials: 'IM', conversationId: 'ida-moller' },
  { id: 'anna-berg', name: 'Anna Berg', initials: 'AB', conversationId: 'anna-berg' },
  { id: 'maya-holm', name: 'Maya Holm', initials: 'MH' },
  { id: 'maya-patel', name: 'Maya Patel', initials: 'MP', location: 'London, UK', conversationId: 'maya-patel' },

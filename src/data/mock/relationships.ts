...
export const relationshipContexts: Readonly<Record<string, RelationshipContext>> = {
  'relationship-sofie-larsen': {
    ...
    listContextLabel: 'In house · Coastal Escape',
    collaborationId: 'collaboration-coastal-escape-sofie-larsen',
    stayId: 'sofie-larsen',
    room: 'Sea View 214',
  ...
  'relationship-clara-moreau': {
    ...
    listContextLabel: 'Arrives tomorrow · Summer Wellness',
    collaborationId: 'collaboration-summer-wellness-clara-moreau',
    stayId: 'clara-moreau',
    room: 'Spa Suite 305',
  ...
  'relationship-ida-moller': {
    ...
    listContextLabel: 'Publishing · Heritage & History',
    collaborationId: 'collaboration-heritage-history-ida-moller',
  },
  'relationship-anna-berg': {
    ...
    listContextLabel: 'Application · Culinary Journey',
  },
  'relationship-james-holloway': {
    ...
    campaignId: 'coastal-escape',
    campaignDates: 'May 1 – May 31, 2025',
    currentContext: 'Arrives today · May 15–17',
    listContextLabel: 'Arrives today · Coastal Escape',
    collaborationId: 'collaboration-coastal-escape-james-holloway',
  ...
  'relationship-maya-patel': {
    ...
    listContextLabel: 'Upcoming · Culinary Journey',
    collaborationId: 'collaboration-culinary-journey-maya-patel',
    stayId: 'maya-patel',
    room: 'Sea View 208',
